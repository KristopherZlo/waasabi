...
return [
    ...
    [
        ...
        'context' => 'building a quiet dashboard for student teams and makers',
        'published' => '5 hours ago',
        'published_minutes' => 300,
        'score' => 22,
        'returns' => 3,
        'saves' => 6,
        'read_time' => '5 min',
        ...
        'body_markdown' => "We are building a calm dashboard for student teams to track weekly progress.\n\nWe need a UI designer who can define the visual system, layout patterns, and a small set of reusable components. The goal is clarity and low cognitive load.\n\nTime: 4-6 hours/week for 3-4 weeks. Remote and async. DM me on profile if interested.",
        'comments' => [],
        'reviews' => [],
        'reviewer' => ['name' => 'Mila T.', 'role' => 'Maker', 'note' => 'Content systems', 'avatar' => '/images/avatar-6.svg'],
        'sections' => [],
    ],
    [
        ...
        'context' => 'shipping a small battery sensor kit for field tests',
        'published' => '8 hours ago',
        'published_minutes' => 480,
        'score' => 18,
        'returns' => 2,
        'saves' => 4,
        'read_time' => '6 min',
        ...
        'body_markdown' => "We have a working prototype and need help polishing the firmware.\n\nScope: low power sleep cycle, sensor polling, and a simple radio packet format. We will share a clear spec and current codebase.\n\nTime: 5-8 hours/week. Remote. Ideal if you have shipped low-power firmware before.",
        'comments' => [],
        'reviews' => [],
        'reviewer' => ['name' => 'Ilya M.', 'role' => 'Maker', 'note' => 'Hardware reviews', 'avatar' => '/images/avatar-4.svg'],
        'sections' => [],
    ],
    [
        ...
        'context' => 'turning chaotic build notes into a clear guide',
        'published' => 'yesterday',
        'published_minutes' => 1440,
        'score' => 15,
        'returns' => 1,
        ...
        'author' => ['name' => 'Katya F.', 'role' => 'user', 'avatar' => '/images/avatar-7.svg'],
        'body_markdown' => "We have strong build notes but they are too chaotic for new contributors.\n\nWe need a technical writer to turn them into a structured guide with screenshots and short summaries. If you have done internal docs or help centers, you will fit.\n\nTime: 3-5 hours/week. Remote. DM me on profile if interested.",
        'comments' => [],
        'reviews' => [],
        'reviewer' => ['name' => 'Katya F.', 'role' => 'User', 'note' => 'Team lead', 'avatar' => '/images/avatar-7.svg'],
        'sections' => [],
    ],
],
    'profile' => [
