...
@section('content')
    <section class="publish-heading">
        <div class="publish-heading__copy">
            <h1>{{ $pageTitle }}</h1>
            <p>{{ $pageSubtitle }}</p>
        </div>
        ...
        <form class="editor-shell" method="POST" action="{{ route('publish.store') }}" enctype="multipart/form-data" data-publish-form data-editing="{{ $isEditing ? '1' : '0' }}" data-publish-type="{{ $editType }}">
            ...
            <div class="editor-grid">
                <main class="editor-main">
                    <section class="editor-panel editor-panel--identity">
                        <label>
                            ...
                            <input class="input editor-title-input" type="text" name="title" placeholder="{{ __('ui.publish.title_placeholder') }}" value="{{ old('title', $editPost['title'] ?? '') }}" data-required data-draft-field="title" data-publish-placeholder data-post-placeholder="{{ __('ui.publish.title_placeholder') }}" data-question-placeholder="{{ __('ui.publish.title_placeholder_question') }}">
                        </label>
                    ...
                    <section class="editor-panel editor-panel--editor" data-publish-section="post">
                        <div class="editor-panel__head">
                            <span class="editor-panel__title">{{ __('ui.publish.content_title') }}</span>
                            <span class="helper">{{ __('ui.publish.markdown_hint') }}</span>
                        </div>
                        <div class="editor-toolbar" data-editor-toolbar>
                            <div class="editor-toolbar__group">
                                <button type="button" class="toolbar-btn" data-editor-action="bold" aria-label="{{ __('ui.publish.toolbar.bold') }}"><i data-lucide="bold" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="italic" aria-label="{{ __('ui.publish.toolbar.italic') }}"><i data-lucide="italic" class="icon"></i></button>
                            ...
                            <div class="editor-toolbar__group">
                                <button type="button" class="toolbar-btn" data-editor-action="bullet" aria-label="{{ __('ui.publish.toolbar.bullet') }}"><i data-lucide="list" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="ordered" aria-label="{{ __('ui.publish.toolbar.ordered') }}"><i data-lucide="list-ordered" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="quote" aria-label="{{ __('ui.publish.toolbar.quote') }}"><i data-lucide="quote" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="code" aria-label="{{ __('ui.publish.toolbar.code') }}"><i data-lucide="code-2" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="spoiler" aria-label="{{ __('ui.publish.toolbar.spoiler') }}"><i data-lucide="eye-off" class="icon"></i></button>
                            </div>
                            <div class="editor-toolbar__group">
                                <button type="button" class="toolbar-btn" data-editor-action="link" aria-label="{{ __('ui.publish.toolbar.link') }}"><i data-lucide="link" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="image" aria-label="{{ __('ui.publish.toolbar.image') }}"><i data-lucide="image" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="table" aria-label="{{ __('ui.publish.toolbar.table') }}"><i data-lucide="table" class="icon"></i></button>
                            </div>
                            <div class="editor-toolbar__group editor-toolbar__group--history">
                                <button type="button" class="toolbar-btn" data-editor-action="undo" aria-label="{{ __('ui.publish.toolbar.undo') }}"><i data-lucide="undo-2" class="icon"></i></button>
                                <button type="button" class="toolbar-btn" data-editor-action="redo" aria-label="{{ __('ui.publish.toolbar.redo') }}"><i data-lucide="redo-2" class="icon"></i></button>
                            </div>
                        </div>
                        <div class="editor-table-panel" data-editor-table-panel hidden>
                            ...
                            <div class="editor-table-actions">
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="add-row-before" aria-label="{{ __('ui.publish.table.row_above') }}"><i data-lucide="arrow-up" class="icon"></i>{{ __('ui.publish.table.row_above') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="add-row-after" aria-label="{{ __('ui.publish.table.row_below') }}"><i data-lucide="arrow-down" class="icon"></i>{{ __('ui.publish.table.row_below') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="delete-row" aria-label="{{ __('ui.publish.table.delete_row') }}"><i data-lucide="minus" class="icon"></i>{{ __('ui.publish.table.delete_row') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="add-column-before" aria-label="{{ __('ui.publish.table.col_left') }}"><i data-lucide="arrow-left" class="icon"></i>{{ __('ui.publish.table.col_left') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="add-column-after" aria-label="{{ __('ui.publish.table.col_right') }}"><i data-lucide="arrow-right" class="icon"></i>{{ __('ui.publish.table.col_right') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="delete-column" aria-label="{{ __('ui.publish.table.delete_col') }}"><i data-lucide="minus" class="icon"></i>{{ __('ui.publish.table.delete_col') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="toggle-header-row" aria-label="{{ __('ui.publish.table.header_row') }}"><i data-lucide="heading" class="icon"></i>{{ __('ui.publish.table.header_row') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="toggle-header-column" aria-label="{{ __('ui.publish.table.header_col') }}"><i data-lucide="heading" class="icon"></i>{{ __('ui.publish.table.header_col') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="toggle-header-cell" aria-label="{{ __('ui.publish.table.header_cell') }}"><i data-lucide="heading" class="icon"></i>{{ __('ui.publish.table.header_cell') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="merge-cells" aria-label="{{ __('ui.publish.table.merge') }}"><i data-lucide="table-cells-merge" class="icon"></i>{{ __('ui.publish.table.merge') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="split-cell" aria-label="{{ __('ui.publish.table.split') }}"><i data-lucide="table-cells-split" class="icon"></i>{{ __('ui.publish.table.split') }}</button>
                                <button type="button" class="ghost-btn editor-table-btn" data-table-action="delete-table" aria-label="{{ __('ui.publish.table.delete_table') }}"><i data-lucide="trash-2" class="icon"></i>{{ __('ui.publish.table.delete_table') }}</button>
                            </div>
                        ...
                        <div class="editor-image-panel" data-editor-image-panel hidden>
                            <div class="editor-image-header">
                                ...
                                <button type="button" class="icon-btn editor-image-close" data-editor-image-close aria-label="{{ __('ui.publish.image.close') }}"><i data-lucide="x" class="icon"></i></button>
                            </div>
                    ...
                    <section class="editor-panel editor-panel--question" data-publish-section="question">
                        <label>
                            <span class="label-text">{{ __('ui.publish.question_label') }}</span>
